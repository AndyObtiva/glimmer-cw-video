...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<glimmer-dsl-swt>.freeze, [">= 4.17.1.0", "< 5.0.0.0"])
...
#       s.add_development_dependency(%q<juwelier>.freeze, ["~> 2.4.9"])
      ...
      s.add_dependency(%q<glimmer-dsl-swt>.freeze, [">= 4.17.1.0", "< 5.0.0.0"])
      s.add_dependency(%q<glimmer-cw-browser-chromium>.freeze, [">= 1.0.0", "< 2.0.0"])
